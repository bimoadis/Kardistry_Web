...
if (isset($_POST["submit"])) {
    if (editClass($_POST) > 0) {
        ...
        echo "<script>
            alert('data edit Gagal disimpan!');
            document.location.href ='basic-table.php';
        </script>";
    }
}
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Ntutor" name="Ntutor" value="<?= $class["Ntutor"] ?>" placeholder="Name Tutor" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Nkelas">Nama Kelas</label>
                                            <select class="form-control" id="Nkelas" name="Nkelas" value="<?= $class["Nkelas"] ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Nmove" name="Nmove" value="<?= $class["Nmove"] ?>" placeholder="Nama Move" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="Link">Link</label>
                                            <input type="text" class="form-control" id="Link" name="Link" value="<?= $class["Link"] ?>" placeholder="Link Pembelajaran" required>
                                        </div>
                                        <!-- <div class="form-group">
